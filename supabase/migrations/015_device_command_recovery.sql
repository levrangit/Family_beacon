-- ============================================================
-- DEVICE COMMAND STALE RECOVERY
-- Re-queues commands that were claimed by a device agent but
-- remained in "executing" longer than the recovery timeout.
--
-- Only commands belonging to the authenticated device are
-- considered.
-- ============================================================
...
begin
    ...
    -- Re-queue only stale commands owned by this device.
